...
ROOT=Path(__file__).resolve().parents[1];DRAFT_ROOT=ROOT/'data/editorial/drafts';OUT=ROOT/'data/editorial/canonical_life_chapters.json';PER_DIR=ROOT/'data/editorial/canonical-life';AUDIT=ROOT/'data/editorial/person_life_relocation_audit.json'
