...
def build()->None:
    ...
    for batch_no,start in enumerate(range(1,101,20),1):
        ...
        for i in range(start,start+20):
            # Base generation writes only missing assets because svg_art is patched above.
    ...
    print('PASS: generated=100 validated=100 ready=100 batches=5 similarity<=0.70')
...
def validate_only()->None:
    ...
    print('PASS: 100 stories, five validated batches, assets preserved')
