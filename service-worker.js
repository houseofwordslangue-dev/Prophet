const CACHE='prophet-biography-v6-4-0-universal-reader';
const ASSETS=[
...
'./reference.html','./reader.html','./references.html','./library.html','./assets/reference.js','./assets/reader.js','./assets/reader.css','./assets/universal-player.js','./assets/references.js','./assets/bookstore.js','./data/references.json',
...
'./data/knowledge.json','./data/media.json','./data/names_201.json','./data/learning.json','./data/calendar.json','./data/graph.json','./data/quran_corpus.json','./data/quran_interpretive_overlay.json','./data/hadith_corpus.json','./data/seerah_daily.json','./data/seerah_corpus.json','./data/seed_articles.json',
...
const NETWORK_FIRST=new Set(['/index.html','/assets/app.js','/assets/styles.css','/data/imported_media.json','/data/imported_quotes.json','/data/fr_generated.json','/data/quran_interpretive_overlay.json','/data/seerah_corpus.json','/reference.html','/reader.html','/references.html','/library.html','/assets/reference.js','/assets/reader.js','/assets/reader.css','/assets/universal-player.js','/assets/references.js','/assets/bookstore.js','/data/references.json']);
