...
function excerpt(a){const t=(a.paragraphs||[]).map(p=>p.text).join(' ');return t.length>155?t.slice(0,155)+'…':t}
function card(a){return `<article class="ep-card" data-section="${esc(a.section)}"><div class="meta">${esc(SECTION_AR[a.section]||a.section)} · ${esc(a.subsection)}</div><h2>${esc(a.title)}</h2><p>${esc(excerpt(a))}</p><div class="foot"><span class="ep-badge">موثّق المصدر 100%</span><a href="${esc(a.articleUrl)}">قراءة المادة</a></div></article>`}
