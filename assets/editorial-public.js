...
const SECTION_AR={light:'النور',prophet:'النبي',messenger:'الرسول',human:'الإنسان',mercy:'الرحمة العظمى',family:'الأسرة',companions:'الصحابة',sources:'المصادر والدراسات',media:'الوسائط',forums:'المنتديات',children:'للأطفال'};
